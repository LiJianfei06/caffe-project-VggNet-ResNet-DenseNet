...
ljftest_alphabet_ResNet     	accuracy: 99.26%;		用ResNet训练						(62个字符，0~9，A~Z,a~z)	也就是0和o判错可能性大
...
ljftest_cifar10_用WRN     		accuracy: 92.21%;		用WRN训练(wide residual network)	cifar10 
