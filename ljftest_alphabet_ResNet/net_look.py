...
if __name__ == '__main__':
    ...
    snapshot_model_dir = root_str +'snapshot_ResNet_iter_150000.caffemodel'
    test_prototxt_dir = "/home/ljf/caffe-master/examples/ljftest_alphabet_ResNet/train.prototxt" 
