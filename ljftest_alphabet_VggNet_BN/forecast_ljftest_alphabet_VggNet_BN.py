...
str_place="/home/ljf/caffe-master/examples/ljftest_alphabet_VggNet_BN/test/image/"


def test(my_project_root, deploy_proto):
    caffe_model = my_project_root + 'caffe_ljftest_train_iter_192000.caffemodel'        #caffe_model文件的位置
