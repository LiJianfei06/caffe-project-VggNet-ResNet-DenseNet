...
if __name__ == '__main__':
    ...
    snapshot_model_dir = root_str +'caffe_ljftest_train_iter_192000.caffemodel'
    test_prototxt_dir = "/home/ljf/caffe-master/examples/ljftest_alphabet_VggNet_BN/train.prototxt" 
